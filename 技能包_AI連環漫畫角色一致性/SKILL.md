...
9. **長期最高 ROI：訓練 Custom Character**（10-20 張、30-60 分、>90% 一致，之後 @角色名 呼叫）。出現在 50 張以上的角色都該做。
   - ★★ **已實戰成功(2026-06-02)：用 Magnific(Freepik) 訓練永久角色 @dizang**，只要 10 點、選 9 張定裝照即可，之後打 `@dizang` 地藏寶冠/錫杖/吉卜力自動鎖。**地藏+WhatDog 狗狗通用，照做 SOP 見 `reference/Magnific訓練角色_實戰SOP_2026-06-02.md`**。LoveArt 沒訓練功能，Magnific 有 → 訓練角色走 Magnific。
